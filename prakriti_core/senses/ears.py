"""
PRAKRITI EARS (Hearing Module)
This module runs in a background thread and listens for the wake word "Prakriti".
"""
...
class Ears:
    def __init__(self, callback_function=None):
        ...
        self.callback = callback_function # Function to call when "Prakriti" is heard
        self.thread = None

    def listen_loop(self):
        """Continuous listening loop."""
        print("👂 Ears: Listening for 'Prakriti' or 'Hey AI'...")
